...
from .views import MovieSearchView, MovieDetailsView, RatingCreateView, RatingDetailView, RatingSearchByUserView
...
urlpatterns = [
    ...
    path('ratings/', RatingSearchByUserView.as_view(), name='user-ratings')
]